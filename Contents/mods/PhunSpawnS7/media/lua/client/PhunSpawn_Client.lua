...
function PhunSpawn:getRandomPoint()
...
function PhunSpawn:getRandomUndiscovered(fromX, fromY, closerThan)
...
function PhunSpawn:doRandomUndiscovered(player)
...
function PhunSpawn:drawSymbol(x, y, symbolName, playerNum, scale)
    if not ISWorldMap_instance then
...
Events.OnServerCommand.Add(function(module, command, arguments)
    if module == PhunSpawn.name and command == "OnEat_VentClue" then
        PhunSpawn:doRandomUndiscovered(getPlayer())
    end
end)
